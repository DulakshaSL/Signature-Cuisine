...
<head>
    ...
    <title>Signature Cuisine - Facilities</title>
...
<section class="explore-section">
    ...
    // Perform a query to fetch facilities from the database
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo '<div class="explore-content ' . ($count % 2 === 0 ? 'even' : 'odd') . '">';
        echo '<img src="resources/' . $row['image'] . '" alt="' . $row['facility_name'] . '" class="explore-image">';
        echo '<div class="explore-text">';
...
<style>
 ...
 #cart-items-list a {
    display: flex; /* Use flexbox to center elements vertically and horizontally */
 ...
 /* Styles for the search result item image */
 .result-image {
    padding-top: 20px;
    width: 100px;
    height: auto;
 ...
 /* Styles for the search result item details */
 .result-details {
    flex: 1;
    padding-left: 20px;
    padding-bottom: 20px;
