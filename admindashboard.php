...
<head>
  ...
  <title>Signature Cuisine - Admin Dashboard</title>
            ...
            while ($reservationRow = mysqli_fetch_assoc($reservationResult)) {
                ...
                echo '<td>
                 <form action="update_status.php" method="post">
                    <input type="hidden" name="id" value="' . $reservationRow['id'] . '">
    ...
    <table id="OnlineOrdertable">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>
                    <form action="upadateonline.php" method="post">
