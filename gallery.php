...
<head>
    ...
    <title>Signature Cuisine - Gallery</title>
</head>
...
<section class="menu-introduction">
  ...
  <div class="intro-content">
    ...
    <p>Welcome to a visual feast that celebrates the artistry and flavor of our Signature Cuisine. 
      Our culinary team takes pride in crafting dishes that not only tantalize the taste buds but also captivate the eyes. 
      Each creation is a masterpiece, a symphony of colors, textures, and exquisite flavors meticulously curated to elevate 
      your dining experience.Explore the gallery and savor the visual allure of our culinary craftsmanship.</p>
...
<?php
 ...
 $query = "SELECT * FROM gallery_headings";
...
<main>
  <section id="gallery">
    <?php
    // Iterate over each set of images with a common heading
    while ($row = mysqli_fetch_assoc($result)) {
    $heading = isset($row['heading']) ? $row['heading'] : 'No Heading';
    echo '<h2>' . $heading . '</h2>';
    echo '<div class="image-grid">';

    // Fetch and display images for the current set
    $imageQuery = "SELECT * FROM gallery_images WHERE heading_id = " . $row['id'];
    ...
    echo '<a>';
    echo '<img src="resources/' . $imageRow['filename'] . '" alt="Image">';
    echo '</a>';
    }
